        ...
        <div className="page-wrapper py-8">
            <div className="container-main">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div className="hidden md:grid md:grid-cols-12 bg-gray-50 border-b border-gray-200 px-6 py-3 text-sm font-semibold text-gray-700">
                    ...
                    <div className="divide-y divide-gray-200">
                        {posts.length === 0 ? (
                            <div className="px-6 py-12 text-center text-gray-500">게시글이 없습니다.</div>
                        ) : (
                            posts.map(post => {
                                const board = boards.find(b => b.board_code === post.board_code);
                                return (
                                    <Link
                                        key={post.id}
                                    ...
                                    >
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-start md:items-center">
                                            ...
                                            <div className="md:col-span-2 text-sm text-gray-600">{post.author_name}</div>
                                            <div className="md:col-span-1 text-sm text-gray-500 text-center">{post.view_count}</div>
                                            <div className="md:col-span-1 text-sm text-gray-500 text-center">{post.comment_count}</div>
                                            <div className="md:col-span-1 text-sm text-gray-500">{formatDate(post.created_at)}</div>
                                        </div>
                                    </Link>
                                );
                            })
